...
class ArtPieceRepositoryTest {
    ...
    void testAddArtPiece(){
        ...
        ArtPiece artPiece = new ArtPiece("M",  1, ArtForm.PAINTING, 1512, 2300000);
    ...
    void testUpdateArtPiece(){
        ArtPieceRepository artPieceRepository = new ArtPieceRepository();
        ArtPiece updatedArtPiece = new ArtPiece("The Creation of Adam",  1, ArtForm.PAINTING, 1512, 2300000);
        Optional<ArtPiece> foundArtPiece =  artPieceRepository.getArtPieceById(1);
    ...
    void testGetAllArtPiece(){
        ArtPieceRepository artPieceRepository = new ArtPieceRepository();
        ArtPiece artPiece1 = new ArtPiece("1",  1, ArtForm.PAINTING, 1, 1);
        ArtPiece artPiece2 = new ArtPiece("2",  1, ArtForm.PAINTING, 2, 2);
        ArtPiece artPiece3 = new ArtPiece("3",  1, ArtForm.PAINTING, 3, 3);
