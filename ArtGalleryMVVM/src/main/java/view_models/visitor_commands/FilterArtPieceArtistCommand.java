...
public class FilterArtPieceArtistCommand implements CommandsInterface {
    ...
    public FilterArtPieceArtistCommand(VisitorViewModel viewModel) {
    ...
    public void execute() {
        ...
        int rowIndex = 0;
        List<ArtPieceArtist> artPieceArtistList = artService.filterNotSoldArtPieceArtistByArtistForm(viewModel.getArtist(), viewModel.getArtForm());
        ...
        viewModel.setModel(defaultTableModel);
    }
}
