...
public class SearchArtPieceArtistByTitleCommand implements CommandsInterface {
    ...
    public SearchArtPieceArtistByTitleCommand(VisitorViewModel viewModel) {
    ...
    public void execute() {
        ...
        int rowIndex = 0;
        List<ArtPieceArtist> artPieceArtistList = artService.searchNotSoldArtPieceArtistByTitle(viewModel.getTitle());
