...
public class VisitorController implements Observer{
    ...
    public void populateArtPieceArtistTable(){
        ...
        int rowIndex = 0;
        List<ArtPieceArtist> artPieceArtistList = connection.getNotSoldArtPieceArtist();
    ...
    private void filterArtPieceArtist(){
        ...
        if(!view.getFormTxtField().getText().equals("")){
            filters.put("form", view.getFormTxtField().getText());
        }
        List<ArtPieceArtist> artPieceArtistList = connection.filterNotSoldArtPieceArtist(filters);
    ...
    private void sortArtPieceArtist(){
        List<ArtPieceArtist> artPieceArtistList = connection.sortNotSoldArtPieceArtist();
        populateArtPieceArtistTable(artPieceArtistList);
        designTables(view.getTable());
    }
