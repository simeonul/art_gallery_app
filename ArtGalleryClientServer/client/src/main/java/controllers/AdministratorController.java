...
public class AdministratorController implements Observer{
    ...
    private ArtPieceArtistConnection artConnection;
    private LogInController logInController;

    public AdministratorController(){
        this.view = new AdministratorView();
        this.userConnection = new UserConnection();
        this.artConnection = new ArtPieceArtistConnection();
    ...
    private void populateUserTable(){
        ...
        int rowIndex = 0;
        List<Users> users = userConnection.getAllUser();
    ...
    private void updateUser(){
        ...
        if (selectedRowUser > -1) {
            ...
            if (isValidInput()) {
                userConnection.updateUser(id, createUser());
                populateUserTable();
                designTables(view.getUserTable());
            }
        }
    ...
    private void populateArtPieceArtistTable(){
        ...
        int rowIndex = 0;
        List<ArtPieceArtist> artPieceArtistList = artConnection.getNotSoldArtPieceArtist();
    ...
    private void filterArtPieceArtist(){
        ...
        List<ArtPieceArtist> artPieceArtistList = artConnection.filterNotSoldArtPieceArtist(filters);
    ...
    private void sortArtPieceArtist(){
        List<ArtPieceArtist> artPieceArtistList = artConnection.sortNotSoldArtPieceArtist();
        populateArtPieceArtistTable(artPieceArtistList);
        designTables(view.getArtPieceTable());
    }
